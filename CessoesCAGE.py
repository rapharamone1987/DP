...
def generate_pdf_reportlab(df):
    ...
    # Orientação Paisagem (Landscape) com Margens de 8mm
    ...
    # Estilos com Helvetica-Bold em Todos os Campos
    ...
    # 1. Listra RS no Topo
    stripe_table = Table([['', '', '']], colWidths=[93*mm, 93*mm, 95*mm], rowHeights=[2.5*mm])
    ...
    # Larguras Redimensionadas (ANUÊNCIA ajustada para 22mm para não quebrar linha)
    col_w = [50*mm, 72*mm, 25*mm, 50*mm, 20*mm, 20*mm, 22*mm, 22*mm]
