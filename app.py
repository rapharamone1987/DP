...
# --- 3. CLASSE PDF COM FAIXAS E TÍTULO PRETO ---
...
# FASE OPERACIONAL
    ...
    obs_geral = st.text_area("Observações Gerais / Justificativas de Desconformidade:")
        ...
        if not servidor: st.error("Informe o servidor.")
            ...
            try:
                ...
                for i, it in enumerate(st.session_state.items_lista):
                    ...
                    atesto_pdf = "RECEBIMENTO " + tipo_atesto.upper()
                ...
                st.download_button("📥 Download PDF", data=pdf.output(dest='S').encode('latin-1'), file_name="Relatorio.pdf")
